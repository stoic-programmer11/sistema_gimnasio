...
<body>
	...
	<div class="contenedor">
		...
		<!-- Formulario -->
		<form action="phpmailer.php" id="formulario-tarjeta" class="formulario-tarjeta" method="post">
			<div class="grupo">
			...
			<div class="grupo">
				...
				<input type="email" id="inputCorreo" name="email" autocomplete="off" required>
			</div>
			<div class="flexbox">
